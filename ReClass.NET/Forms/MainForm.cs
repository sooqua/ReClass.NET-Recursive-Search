...
namespace ReClassNET.Forms
{
	public partial class MainForm : IconForm
	{
		...
		public MemoryViewControl GetMemoryViewControl()
		{
			return this.memoryViewControl;
		}
		...
		private void selectedNodeContextMenuStrip_Opening(object sender, CancelEventArgs e)
		{
			...
			recursiveSearchToolStripMenuItem.Enabled = nodeIsClass;
		...
		private void recursiveSearchToolStripMenuItem_Click(object sender, EventArgs e)
		{
			using var rsf = new RecursiveSearchForm();
